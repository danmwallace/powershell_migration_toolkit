...
function Get-M365UserMigrationData {
    ...
    try {
        Connect-MgGraph -TenantId $TenantID -Scopes "User.Read.All", "Group.Read.All", "Directory.Read.All", "Reports.Read.All", "AuditLog.Read.All", "Sites.Read.All", "Files.Read.All"
    ...
    foreach ($User in $Users) {
        ...
        $CustomObject = [PSCustomObject]@{
            ...
            AssignedLicenses     = $ReadableLicenseList
